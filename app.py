...
routes = [(r"/uploadimgpdf",    "handlers.images.UploadImagesHandler"),
          (r"/upload",          "handlers.uploadfile.UploadImagesPDFHandler"),
          (r"/uploadapi/(.*)",  "handlers.uploadfile.UploadApiHandler"),
          (r"/img2xmlcontent",  "handlers.img2xml.Img2XmlContentHandler"),
          (r"/download",        "handlers.download.DownloadFileHandler")
          ]
